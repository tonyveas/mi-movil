      ...
      <IonReactRouter>
        <IonSplitPane contentId="main">
          ...
          <IonRouterOutlet id="main">
            ...
            <Route path="/medico/homepacientes" component = {HomePacientes} exact />
            <Route path="/medico/homepacientes/expedientepaciente/:ced" component = {ExpedientePaciente} exact={true} />
            {/* <Route path="/iniciarsesion2" component = {Login} exact={true} /> */}
            {/* <PrivateRoute exact path="/iniciarsesion" component = {Login} /> */}
