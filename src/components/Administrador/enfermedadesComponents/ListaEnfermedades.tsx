...
const ListaEnfermedades  = (props:any) => {

    const [detalleVentana, setDetalleVentana] = React.useState(false);    

    return (
        <div>
            <IonItem key = {props.id_enfermedad} className = "ion-activatable">
                <IonLabel onClick={() => setDetalleVentana(true)}>
                    <IonRippleEffect></IonRippleEffect>
                    <h2><b>{props.nombreCorto}</b></h2>
                    <h3>{props.nombreLargo}</h3>
                    <p>Descripción: {props.descrip}</p>
                </IonLabel>
                <IonAvatar slot="start">
                    <img src="./assets/img/icons/enfermedades/enfermedad.png"  alt="enfermedad" />
                </IonAvatar> 
                <IonButton size="default" fill="clear" routerLink={`/admin/edit/enfermedades/${props.id_enfermedad}`}><IonIcon slot="end" color="medium" icon={create}></IonIcon></IonButton>
            ...
            <IonModal
                ...
                <IonToolbar color="primary">
                    <IonTitle>Detalle Enfermedad</IonTitle>
                    <IonButtons slot="end">
                ...
                <IonContent>
                    <IonList lines = "none">
                        <IonItem>
                            <img style={{ marginLeft: 150, marginTop: 25, marginBottom: 25 }} src="./assets/img/icons/enfermedades/enfermedad.png"  alt="enfermedad" />
                        </IonItem>
                        <IonItem>
                            <IonIcon slot="start" icon={key}></IonIcon>
                            <IonLabel>Id</IonLabel>
                            <IonNote slot="end">{props.id_enfermedad}</IonNote>
                        </IonItem>
                        <IonItem>
                        ...
                        <IonItem>
                            ...
                            <IonLabel>Nombre Largo</IonLabel>
                            <IonNote slot="end">{props.nombreLargo}</IonNote>
                        </IonItem>
                        <IonItem>
