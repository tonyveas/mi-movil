      ...
      <IonPage>
        <IonHeader>
          <IonToolbar color="primary">
            ...
            <IonButtons slot="end">
              <IonButton shape="round" slot="end" size="large" routerLink="/paciente/recordatorios"><IonIcon icon={notifications}></IonIcon><IonBadge color="light">{cantidad}</IonBadge></IonButton>
            </IonButtons>
            {/* <IonButtons slot="end">
