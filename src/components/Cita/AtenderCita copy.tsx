...
const AtenderCita = (props:any) => {
    ...
    const remove_discapacidad = (id:any) => {
        ...
        // let nuevas_discapacidades_values = valoresDiscapacidadesAgregadas;
        let nuevas_discapacidades_values = valoresDiscapacidadesAgregadas;
        //console.log("ANTES: ",nuevas_discapacidades_values);

        let prop:any = "discapacidad"+id;
        //console.log("ZZZZZ: ",prop);
        delete nuevas_discapacidades_values[prop]

        //console.log("DESPUÉS: ",nuevas_discapacidades_values);

        //console.log("ID: ",id);
        // let { discapacidad0, ...update} = valoresDiscapacidadesAgregadas;
        console.log("valoresDiscapacidadesAgregadas: ",valoresDiscapacidadesAgregadas)
            ...
            <IonContent fullscreen>
                {
                    actualPage === 0?
                        <>
                            <IonCard>
                                <IonCardHeader>
                                    <IonCardTitle className = "ion-text-center">Antecedentes</IonCardTitle>
                                </IonCardHeader>
                            </IonCard>
                            ...
                            <IonRow  className = "ion-text-center">
                                <IonCol  className = "ion-text-center">
                                    ...
                                    <IonItem>
                                        <IonTextarea rows = {2} className = "ion-margin-top" required disabled = {false} ></IonTextarea>                            
                                    </IonItem>
                                </IonCol>
                            </IonRow>
