...
import ListaRecordatorios from '../Administrador/recordatoriosMedicoComponents/ListaRecordatorios';
import AxiosCitas from '../../Services/AxiosCitas';

const RecordatoriosMedicos = (props:any) => {
                ...
                <IonList>
                    {
                        recordatorios.map( (item:any) => (
                            <ListaRecordatorios key = {item.id}
                                estado = {item.estado}
                                start = {item.start}
                                end = {item.end}
                                nombre = {item.nombre}
...
export default RecordatoriosMedicos;