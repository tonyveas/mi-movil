    ...
    <IonButton shape="round" slot="end" size="large" routerLink="/recordatoriosactualeshome"><IonIcon icon={notifications}></IonIcon><IonBadge color="light">{cantidad}</IonBadge></IonButton>
        ...
        <IonContent>
          <IonGrid class="grid">
            ...
            <IonRow  class="row">
              <IonCol  size="12">     
                <IonButton color="primary" class="boton" routerLink="/medico/agendaCitas" expand="block" size="large">
                <div className="margen">
            ...
            <IonRow  class="row">
              <IonCol  size="12">     
                <IonButton color="primary" class="boton" routerLink="/medico/seguimientos" expand="block" size="large">
                <div className="margen">
